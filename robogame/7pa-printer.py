...
async def main():
    ...
    runloop.run(motor.run_for_degrees(port.D, 130, 300), motor.run_for_degrees(port.C, 60, 300))
    await move(-8)
    runloop.run(motor.run_for_degrees(port.D, -130, 300), motor.run_for_degrees(port.C, -60, 300))
    await move(-50, Speed.Fast)

    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 45, 0)

    # v1
    # await move(50, Speed.Fast)
    # runloop.run(motor.run_for_degrees(port.D, 100, 300), motor.run_for_degrees(port.C, 60, 300))
    # await move(-8)
    # await motor.run_for_degrees(port.C, -100, 300)
    # await move(-10, Speed.Fast)
    # await move(6)
    # await motor.run_for_degrees(port.D, -100, 300)
    # await move(-50, Speed.Fast)
