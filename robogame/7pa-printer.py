...
async def main():
    ...
    await move(55, Speed.Fast)
    runloop.run(motor.run_for_degrees(port.D, -360*5, 500), motor.run_for_degrees(port.C, 60, 300))
    await move(-8)
    runloop.run( motor.run_for_degrees(port.C, -60, 300))
